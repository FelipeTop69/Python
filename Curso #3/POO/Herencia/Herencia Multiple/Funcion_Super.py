# Aqui veremos que el metodo super nos permitira hacer que nuestra clase 
# con herencia multiple pueda recibir diferentes metodos con el mismo nombre 
# incluso si hay priorida. Como es el caso del constructor en scrip de Herencia Multiple.py
